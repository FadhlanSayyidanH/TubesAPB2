...
void main() {
  ...
  group('evaluateFace', () {
    ...
    test('tanpa wajah ditolak dengan alasan noFace', () {
      final r = evaluateFace(
        const FaceMetrics(faceCount: 0, brightness: 120, blurVariance: 300),
      );
    ...
    test('lebih dari satu wajah ditolak', () {
      final r = evaluateFace(
        const FaceMetrics(faceCount: 2, brightness: 120, blurVariance: 300),
      );
    ...
    test('terlalu gelap ditolak', () {
      final r = evaluateFace(
        const FaceMetrics(faceCount: 1, brightness: 30, blurVariance: 300),
      );
    ...
    test('terlalu terang/silau ditolak', () {
      final r = evaluateFace(
        const FaceMetrics(faceCount: 1, brightness: 240, blurVariance: 300),
      );
    ...
    test('foto buram ditolak', () {
      final r = evaluateFace(
        const FaceMetrics(faceCount: 1, brightness: 120, blurVariance: 50),
      );
    ...
    test('pencahayaan dicek sebelum blur: frame gelap & buram → tooDark', () {
      ...
      final r = evaluateFace(
        const FaceMetrics(faceCount: 1, brightness: 20, blurVariance: 10),
      );
      expect(r, FaceRejection.tooDark);
    });
    ...
    test('jumlah wajah diprioritaskan di atas pencahayaan/blur', () {
      final r = evaluateFace(
        const FaceMetrics(faceCount: 0, brightness: 20, blurVariance: 10),
      );
      expect(r, FaceRejection.noFace);
    });
  });
  ...
  group('FaceRejectionMessage', () {
    test('tiap alasan punya pesan Bahasa Indonesia yang sesuai', () {
      ...
      expect(
        FaceRejection.multipleFaces.message,
        AppStrings.faceMultipleDetected,
      );
